class Api::V1::DocumentsController < Api::V1::BaseController
  ...
  def index
    documents = Ragdoll::Document.includes(:embeddings)
  ...
  def show
    render json: {
      ...
      embeddings: @document.embeddings.map(&method(:embedding_json))
    }
  end
  ...
  def document_json(document)
    {
      ...
      embedding_count: document.embeddings.count,
  ...
  def embedding_json(embedding)
    {
      ...
      vector_dimensions: embedding.vector&.size || 0,
